...
var handleFunctionParameter = function(expectedSet, propertyValue) {
  if (typeof (expectedSet) === 'function' && Immutable.Iterable.isIterable(propertyValue)) {
...
var rules = {
  ...
  withValueFrom: function(propertyValue, expectedSet) {
    expectedSet = handleFunctionParameter(expectedSet, propertyValue);
    return propertyValue.size === expectedSet.size && this.withAll(propertyValue, expectedSet);
  }
...
module.exports = function(constraints) {
  constraints = Immutable.fromJS(constraints);
