...
/**
 * This function generates a test plan with a single test which is the result of a random
 * walk through the test models transitions. 
 *
 * @param {Array} transitions a list of transition objects.
 * @param {Object} options a set of options for the strategy.
 * @param {number} options.seed a seed value for the PRNG driving the walk.
