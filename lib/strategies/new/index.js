...
function interleaveVerifications(path, verifications) {
...
module.exports = function(transitions, verifications) {
  return filterDuplicates(findPaths(transitions)).map(function(path) {
    return interleaveVerifications(path, verifications);
